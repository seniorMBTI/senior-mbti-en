...
// MBTI compatibility data - moved outside component
  ...
  useEffect(() => {
    if (resultData && mounted) {
      ...
      if (mbtiInfo) {
        ...
        updateNameMetaTag('twitter:title', `${mbtiType} ${mbtiInfo.title} - Senior MBTI Result`);
        updateNameMetaTag('twitter:description', `Your MBTI is ${mbtiType} ${mbtiInfo.title}. ${mbtiInfo.subtitle}`);
      ...
      <footer className="result-footer">
        <div className="footer-content">
          <p className="footer-text">
            Advertising Inquiries: <a href="mailto:seniorMBTI@gmail.com" className="footer-email">seniorMBTI@gmail.com</a>
          </p>
        </div>
      </footer>
